...
void cScaleTo::Init(std::vector<sPair> vecDetails)
{
...
void cScaleTo::SetGameObject(cGameObject* pGO)
{
	this->m_pTheGO = pGO;
	return;
}

void cScaleTo::Update(double deltaTime)
{
